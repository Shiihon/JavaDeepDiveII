package org.example.threadedFetchesJokes.services;
...
public class JokeService {
    ...
    public static <T> T getJokeFromApi(Class<T> dtoClass, String uri) {
    ...
    public static DadJokeDTO getRandomDadJoke() {
